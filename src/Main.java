...
//        schedule1.addDiscipline(pp1, LESSON_TYPE.LECTURE, 0, 10); // 10 - 12 lecture
//        schedule1.addDiscipline(pp1, LESSON_TYPE.LECTURE, 0, 11);
//        schedule1.addDiscipline(pp1, LESSON_TYPE.LAB, 0, 14); // 14 - 16 lab
//        schedule1.addDiscipline(pp1, LESSON_TYPE.LAB, 0, 15);
//        schedule1.addDiscipline(math1, LESSON_TYPE.LAB, 1, 12); // 12 - 14 lab
//        schedule1.addDiscipline(math1, LESSON_TYPE.LAB, 1, 13);
//        schedule1.addDiscipline(math1, LESSON_TYPE.LECTURE, 6, 8); // 8 - 10 lecture
//        schedule1.addDiscipline(math1, LESSON_TYPE.LECTURE, 6, 9);
//        schedule1.addDiscipline(discrete, LESSON_TYPE.LECTURE, 2, 10); // 10 - 12 lecture
//        schedule1.addDiscipline(discrete, LESSON_TYPE.LECTURE, 2, 11);
//        schedule1.addDiscipline(discrete, LESSON_TYPE.LAB, 3, 14); // 14 - 15 lab
//        // Eng every mon, wed, fri 9 - 10 lab
//        schedule1.addDiscipline(engA2, LESSON_TYPE.LAB, 0, 9);
//        schedule1.addDiscipline(engA2, LESSON_TYPE.LAB, 2, 9);
//        schedule1.addDiscipline(engA2, LESSON_TYPE.LAB, 4, 9);
//
//        schedule1.display();
